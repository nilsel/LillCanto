...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/aurora.js":[function(require,module,exports) {
'use strict';
...
function drawRay(x, y1, y2, life, ttl, width, hue) {
  ...
  gradient.addColorStop(0.5, "hsla(".concat(hue, ",100%,65%,").concat(fadeInOut(life, ttl), ")"));
  gradient.addColorStop(1, "hsla(".concat(hue, ",100%,65%,0)"));
  ctx.a.save();
  ctx.a.beginPath();
...
},{}]},{},["../../../.nvm/versions/node/v10.15.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js","js/aurora.js"], null)
//# sourceMappingURL=/aurora.1ff7861c.js.map